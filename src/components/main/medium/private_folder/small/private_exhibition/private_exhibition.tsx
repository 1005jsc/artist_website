...
import styles from "./private_exhibition.module.css";

const PrivateExhibition = () => {

  return <div className={styles.private_exhibition_container} >
...
export default PrivateExhibition;