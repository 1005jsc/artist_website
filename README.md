...
2. 어떤 니즈를 충족시킬 것인가에 대한 고찰
	...
	- 디자인 적인 면: 본 웹페이지를 제작하기 위해 이미 시중에 나와있는 미술작가 웹사이트들을 여러 참고 해본 결과 종합적으로 아쉬웠던 경우들을 본인 혼자 나름대로 정리해 보았다. 작품사진들이 고화질이지 못해 작품의 감동이 관람객들에게 전달이 잘 되지 않았던 경우, 투자, 매매와 같은 상업적인 부분에 치중해 작가와 작품의 예술적인 퀄리티가 2순위 된 경우(특히 갤러리들이 만든 웹사이트), 그 중 가장 아쉬웠 경우는 작가의 매력과 개성이 잘 느껴지지 않았던 경우였다. 모름지기 미술작가 웹사이트라면 작가의 개성, 독창성, 심미성이 그 어떤 종류의 웹사이트 보다 강하게 갖춰저 있어야 한다고 생각하는데 그 부분이 느껴지지가 않는 웹사이트가 종종 보여서 안타까운 경우가 많았었다. 이번에 만들 웹사이트는 **작가중심, 작가의 개성이 물씬 느껴지는 웹사이트였으면 좋겠다**는 생각을 하였다. 
