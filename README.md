...
- 웹사이트 유저들에게 조용남 작가님을 소개하고 작가님의 작품들을 고화질의 이미지로 전시합니다.
...
3. 웹사이트의 **핵심 키워드**, 반드시 충족해야할 **핵심 가치**, **지켜야할 원칙** 정하기
   ...
   - 핵심 키워드를 통한 **핵심 가치** 정하기
     ...
     - 웹사이트가 '진정성이 있다'라는 것은 무엇을 뜻하는 것인지 생각해 보았다. '진정성이 있는 웹사이트'는, 본 웹사이트를 만들면서 기대할 수 있는 수 많은 가치 중 가장 값어치가 높은 가치를 고르고, 그 가치가 가장 잘 실현된 웹사이트라고 생각했다.
